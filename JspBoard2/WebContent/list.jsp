...
<table border="1" width="700" cellpadding="0" cellspacing="0" align="center"> 
   ...
   <tr height="30" onmouseover="this.style.backgroundColor='white'" onmouseout="this.style.backgroundColor='#e0ffff'"><!-- 하나씩 감소하면서 출력하는 게시물번호 -->
    ...
    <td align="center"  width="150"><fmt:formatDate value="${article.reg_date}" timeStyle="medium" pattern="yy.MM.dd (hh:mm)"/></td>
...
<p>
<!-- 검색어 추가(자주 검색이 되는 항목을 잘선택) 제목,작성자,제목+본문 
	1.기존의 list.do에 추가
	2.새로운 액션클래스를 작성(search.do)
-->
